...
public class AboutMenu extends Application{
	...
	public void start(Stage primaryStage){
		try{
			...
			//create text 
			Label instructionLabel = new Label("This game has been created for OOP1 project by:\n"+
			"ROY, ARNAB      14-26473-2     arnbz.roy@gmail.com\n" +  
			"ISLAM, ZAEDUL   14-26589-2     khzayed1@gmail.com");			
